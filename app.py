...
def main_page():
    ...
    return render_template("index_html.html",name_of_purchaser=name_of_purchaser,name_of_party=name_of_party)
bond_number=0
...
def a_2():
    ...
    if len(data)==0:
        return render_template('index_html.html',a_2_data = [['Not Found']])
    
    return render_template("html_1.html", a_2_data = data,filter=['Name of Purchaser','Name of Party'],bond_number=bond_number) 
...
def e_1():
    if request.method == "POST":
        ...
        return render_template('html_1.html', a_2_data=data, filter=['Name of Purchaser', 'Name of Party'])
...
def e_2():
    if request.method == "POST":
        ...
        cursor.execute("select 'bond_number', 'Denominations', year from csv_1-Copy where 'Name of the Purchaser' = %s",(request.form['Company'],))
        data=cursor.fetchall()
        d = {}
        for row in data:
            bond_number = row[0]
    ...
    name_of_purchaser,name_of_party=get_data()
    return render_template('html_2.html',e_2_data = data,years=years,amount=amount)
...
def e_3():
    ...
    name_of_purchaser,name_of_party=get_data()
    return render_template('html_3.html',e_3_data = data,years1=years,amount1=amount)
...
def e_4():
    if request.method=="POST":
        ...
        return render_template('html_4.html',companies=companies,total_amount=total_amount,e_4_data = list(d.items()),party=request.form['party'])
...
def e_5():
    if request.method=="POST":
        ...
        name_of_purchaser,name_of_party=get_data()
        return render_template('html_5.html',e_5_data = list(d.items()),parties=parties,total_amount=total_amount,total_denominations=total_denominations,company=request.form['company'])
...
def e_6():
    ...
    return render_template('html_6.html', party=party, total_donations=total_donations)
